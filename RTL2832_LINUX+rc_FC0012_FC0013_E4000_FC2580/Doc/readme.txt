...
Some Description 
1  Use the parameter "dtmb_err_discard" to choose whether to discard error TS packet or not when device is on dtmb mode.
...
2  If any problems, please set the parameter "debug=1" to show debug messages when driver is probed, and
